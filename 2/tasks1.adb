...
package body tasks1 is
   ...
   getdistancesensorDataTasksPeriod : constant time_span := Milliseconds(20);
	...
	getLightSensorDataTaskPriority : constant System.Priority := System.Priority'First + 1 ;
        ...
        getdistancesensorDataTasksPriority : Constants System.Priority'First + 3;
	displayTaskPriority :	constant System.Priority := System.Priority'First + 4 ;
	...
	getLightSensorDataTaskStorage : constant Integer := 4096 ;
        ...
        getdistancesensorDataTasksStorage : constant Integer : = 3072;
